...
Обращаем ваше внимание, что проект не адаптирован под планшеты и мобильные устройства.
...
* во время создания\редактироования статьи нельзя удалить выбранные теги;
